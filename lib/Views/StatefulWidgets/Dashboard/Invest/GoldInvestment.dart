...
class GoldInvestment extends StatefulWidget {
  const GoldInvestment({Key? key, title = "Gold"}) : super(key: key);

  @override
  _GoldInvestmentState createState() => _GoldInvestmentState();
}
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                ...
                                child: Text("Gold", style: TextStyle( fontWeight: FontWeight.w900,),),
                              ),
                              SizedBox(height: 10,),
                              ...
                              Padding(
                                ...
                                child: Text("Ksh 50,001 to Ksh 150,000", style: TextStyle( fontWeight: FontWeight.w600,),),
                              ),
                              SizedBox(height: 20,),
