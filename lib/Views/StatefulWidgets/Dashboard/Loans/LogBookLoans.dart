...
class LogBookLoans extends StatefulWidget {
  const LogBookLoans({Key? key, title = "LogBook Loans"}) : super(key: key);

  @override
  _LogBookLoansState createState() => _LogBookLoansState();
}

class _LogBookLoansState extends State<LogBookLoans> {
  @override
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Logbook Loan", style: TextStyle(color: AppColors.black,fontWeight: FontWeight.w600,fontSize: 20),),
                      SizedBox(height: 10,),

                      Text("Ksh 100,000 to Ksh 5,000,000", style: TextStyle(color: AppColors.grey,fontWeight: FontWeight.w500,),),
                      SizedBox(height: 10,),
                      TextFormField(
