...
class BusinessLoans extends StatefulWidget {
  const BusinessLoans({Key? key, title = "Business Loans"}) : super(key: key);

  @override
  _BusinessLoansState createState() => _BusinessLoansState();
}

class _BusinessLoansState extends State<BusinessLoans> {
  @override
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Business Loan", style: TextStyle(color: AppColors.black,fontWeight: FontWeight.w600,fontSize: 20),),
                      SizedBox(height: 10,),

                      Text("Ksh 500 to Ksh 100,000", style: TextStyle(color: AppColors.grey,fontWeight: FontWeight.w500,),),
                      SizedBox(height: 10,),
                      TextFormField(
