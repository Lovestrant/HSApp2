...
class PersonalLoans extends StatefulWidget {
  const PersonalLoans({Key? key, title = "Personal Loans"}) : super(key: key);

  @override
  _PersonalLoansState createState() => _PersonalLoansState();
}
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text("Personal Loans", style: TextStyle(color: AppColors.black,fontWeight: FontWeight.w600,fontSize: 20),),
                      SizedBox(height: 10,),

                      Text("Ksh 500 to Ksh 50,000", style: TextStyle(color: AppColors.grey,fontWeight: FontWeight.w500,),),
                      SizedBox(height: 10,),
                      TextFormField(
